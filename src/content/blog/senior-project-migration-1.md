...
모노레포 환경을 구축할 예정이기 때문에, 팀원이 합류했을 때 동일한 환경에서 쉽고 원할하게 프로젝트에 참여할 수 있도록 환경을 비교적 쉽게 구축 할 수 있게 됩니다. eslint, prettier, commitlint, stylelint, tsconfig 등 각 프로젝트에서 사용되는 패키지들의 config 파일들을 프로젝트 root에서 관리해, 각 프로젝트에서 참조해서 처음 프로젝트에 합류하더라도 전체 프로젝트 환경을 쉽게 이해하고 참여할 수 있도록 환경을 구축할 예정입니다.
